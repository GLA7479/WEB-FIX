...
className="relative w-full h-full rounded-2xl overflow-hidden mt-1 mx-auto border border-slate-700"
    style={
      isDesktop
        ? { maxWidth: "1024px", aspectRatio: "4 / 3" }
        : { maxWidth: "680px" } // במובייל בלי aspect-ratio, שיתפוס כל הגובה
    }
>
  <canvas
    id="miners-canvas"
